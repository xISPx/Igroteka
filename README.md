...
**45 мини-игр на чистом JavaScript. Неоновый hub, рекорды, звук — и ни одной зависимости.**
...
![games](https://img.shields.io/badge/мини--игры-45-b388ff?style=flat-square&labelColor=0d1117)
...
| | |
| --- | --- |
| 🗂 **Единый hub** | Все 45 игр на одной главной: разделы, описания, рекорды прямо на карточках |
...
```
index.html            — главная страница (5 разделов, 45 карточек)
...
Первые 15 игр самостоятельные (собственная разметка и стили), остальные 30 построены на
